...
import { DIGI_API, DIGI_API_WEBSOCKET, ORIGIN } from './config';
...
const wsLink = DIGI_API_WEBSOCKET
  ? new WebSocketLink(
      new SubscriptionClient(DIGI_API_WEBSOCKET, { lazy: true, reconnect: true }, WebSocket)
    )
  : null;
