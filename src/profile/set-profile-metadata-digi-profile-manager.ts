...
export const setProfileMetadataDiGiProfileManager = async () => {
  ...
  await waitUntilDiGiManagerTransactionIsComplete(result, 'setProfileMetadata');
};

(async () => {
  if (explicitStart(__filename)) {
    await setProfileMetadataDiGiProfileManager();
  }
})();
