...
const createMomokaPostWithDiGiManager = async (request: MomokaPostRequest) => {
...
const createPostOnMomoka = async (
  ...
  console.log(
    'create momoka post with digi-manager: createMomokaPostWithDiGiManager',
    result
  );
...
export const postOnMomokaDiGiProfileManager = async () => {
...
(async () => {
  if (explicitStart(__filename)) {
    await postOnMomokaDiGiProfileManager();
  }
})();
