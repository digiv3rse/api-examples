import { DiGiProfileManagerRelayError, RelayError, RelaySuccess } from '../graphql/generated';
...
export async function waitUntilDiGiManagerTransactionIsComplete(
  result: RelaySuccess | DiGiProfileManagerRelayError,
  name: string
) {
